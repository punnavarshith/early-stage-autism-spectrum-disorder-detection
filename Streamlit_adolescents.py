...
feature_columns = ['age', 'gender', 'ethnicity', 'jundice', 'autism', 'relation' ,'contry_of_res', 
                    'A1_Score', 'A2_Score', 'A3_Score', 'A4_Score', 'A5_Score', 'A6_Score',
                   'A7_Score', 'A8_Score', 'A9_Score', 'A10_Score','result',]

# Define the reference columns based on the dataset
reference_columns = pd.get_dummies(data[feature_columns]).columns.tolist()
